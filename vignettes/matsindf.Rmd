...
<tt>matsindf</tt> data frame using using information within the data frame itself.
...
|--------------------------------------------:|:--------------------------------
| <tt>matnames</tt>                           | Input column of matrix names          
| <tt>values</tt>                             | Input column of matrix entries        
| <tt>rownames</tt>                           | Input column of matrix row names      
| <tt>colnames</tt>                           | Input column of matrix column name    
| <tt>rowtypes</tt>                           | Input column of matrix row types      
| <tt>coltypes</tt>                           | Input column of matrix column types   
...
Each application will have its own algorithm for identifying 
...
To illustrate the power of <tt>byname</tt> functions in the context of <tt>matsindf</tt>,
...
| <tt>drop</tt>                               | A value to be dropped from output (often 0)
