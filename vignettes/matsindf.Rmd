---
title: "Use Cases and Examples for <tt>matsindf</tt>"
...
Furthermore, <tt>matsbyname</tt> is a sister package that ...
...
When used together, <tt>matsindf</tt> and <tt>matsbyname</tt>
...
* demonstrates analyzing the matrices with <tt>matsbyname</tt> functions,
...
| <tt>rowtypes</tt>                           | Optional name of the input column of matrix row types      
| <tt>coltypes</tt>                           | Optional name of the input column of matrix column types   
...
of the <tt>matsindf</tt> and <tt>matsbyname</tt> packages.
...
Energy balance verification can be implemented with <tt>matsbyname</tt> functions
...
To further illustrate the power of <tt>matsbyname</tt> functions 
...
| <tt>rowtypes</tt>                           | Optional name of the output column of matrix row types      
| <tt>coltypes</tt>                           | Optional name of the output column of matrix column types   
| <tt>drop</tt>                               | Optional value to be dropped from output (often 0)
...
This vignette demonstrated the use of the <tt>matsindf</tt> and <tt>matsbyname</tt> packages
and suggested a workflow to accomplish
sophisticated analyses using *matrices in data frames* (<tt>matsindf</tt>).

The workflow is as follows:

* Munge data into a tidy data frame with columns for
...
using <tt>matsbyname</tt> functions in a manner similar to the process of generating
