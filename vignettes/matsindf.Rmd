...
the tidy data frame can be collapsed to a matsindf data frame.
<tt>collapse_to_matrices</tt> relies on grouping to form matrices.
...
The result is a <tt>matsindf</tt> data frame.
