...
`U_colname` and `V_colname` arguments to `calc_W` are 
"`U`" and "`V`".
...
But it may be clearer to name the arguments as required by the `calc_W` function
...
the following approach works, too.
