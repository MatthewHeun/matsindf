...
from item names in \texttt{.dat}
to arguments in the signature of \texttt{FUN}.
In the example below,
\texttt{a = "z"} indicates that argument \texttt{a} to \texttt{FUN}
should be supplied by item \texttt{z} in \texttt{.dat}.
...
\label{sec:advanced_data_structures}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\texttt{.dat} can be a list (as shown in several examples above),
